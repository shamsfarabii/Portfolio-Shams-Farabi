        ...
        <div id='Hero'>
            <div className='md:flex md:flex-row-reverse items-center justify-center lg:h-[450px] animate-fade bg-slate-900 text-white'>
                ...
                <div className='md:w-1/2 flex flex-col items-center justify-center'>
                    <div className='flex items-center mt-20 md:ml-[100px] animate-fade-left justify-center'>
                    ...
                    <div className='mt-5 ml-10 mb-20 md:mr-0 animate-fade-left text-xl text-center'>
                        <p>
